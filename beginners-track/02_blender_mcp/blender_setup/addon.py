...
# Optional compatibility hook for older Add-on UI. Never ship a shared trial key.
RODIN_FREE_TRIAL_KEY = os.getenv("BLENDERMCP_HYPER3D_TRIAL_KEY", "")
...
class BLENDERMCP_OT_SetFreeTrialHyper3DAPIKey(bpy.types.Operator):
    ...
    def execute(self, context):
        if not RODIN_FREE_TRIAL_KEY:
            self.report({'ERROR'}, "Set BLENDERMCP_HYPER3D_TRIAL_KEY before using this option")
            return {'CANCELLED'}
